        ...
        <transition name="sort">
          <div class="sort" v-show="show">
            ...
            <div class="all-sort-list2" @click="goSearch">
              <div class="item" v-for="(c1, index) in categoryList.slice(0,16)" :key="c1.categoryId" @mouseenter="changeIndex(index)">
                ...
                <div class="item-list clearfix" :style="{
                  ...
                  <div class="subitem" v-for="(c2, index) in c1.categoryChild.slice(0,8)" :key="c2.categoryId">
                    <dl class="fore">
                      <dt>
